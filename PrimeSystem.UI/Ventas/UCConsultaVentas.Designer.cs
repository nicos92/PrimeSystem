namespace PrimeSystem.UI.Ventas
{
    partial class UCConsultaVentas
    {
        ...
        private void InitializeComponent()
        {
            ...
            tableLayoutPanel7.Controls.Add(BtnLimpiar, 5, 1);
            ...
            BtnLimpiar.BackColor = Color.FromArgb(83, 96, 108);
            BtnLimpiar.FlatAppearance.BorderColor = Color.FromArgb(214, 228, 243);
            BtnLimpiar.FlatStyle = FlatStyle.Flat;
            BtnLimpiar.Font = new Font("Segoe UI Semibold", 12F, FontStyle.Bold);
            BtnLimpiar.ForeColor = Color.White;
            BtnLimpiar.Location = new Point(387, 62);
            BtnLimpiar.Name = "BtnLimpiar";
            BtnLimpiar.Size = new Size(64, 31);
