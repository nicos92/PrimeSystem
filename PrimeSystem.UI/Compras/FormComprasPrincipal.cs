...
{
    public partial class FormComprasPrincipal : Form
    {
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="FormComprasPrincipal"/>.
        /// </summary>
        /// <param name="serviceProvider">El proveedor de servicios para la inyección de dependencias.</param>
        public FormComprasPrincipal(IServiceProvider serviceProvider)
        {
        ...
        {
            BtnOpcionIngresar.Tag = typeof(UCIngresoCompra);
            BtnOpcionEditar.Tag = typeof(UCConsultaCompras);
        }
        ...
        /// <param name="sender">El objeto que generó el evento.</param>
        /// <param name="e">Los datos del evento.</param>
        private void FormComprasPrincipal_Load(object sender, EventArgs e)
        {
            ConFigBtns();
        ...
        /// <param name="sender">El objeto que generó el evento.</param>
        /// <param name="e">Los datos del evento.</param>
        private void FormComprasPrincipal_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Dispose();
        }
    }
